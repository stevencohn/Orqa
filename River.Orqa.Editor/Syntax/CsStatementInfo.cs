namespace River.Orqa.Editor.Syntax
{
    ...
    public class CsStatementInfo : StatementInfo, IHasLocalVars
    {
        // Methods
        public CsStatementInfo()
        {
        }

        public CsStatementInfo(string Name, Point Position, int Level) : base(Name, Position, Level)
        {
        }
