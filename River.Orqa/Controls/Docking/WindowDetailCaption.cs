...
namespace River.Orqa.Controls.Docking
{
    ...
    public class WindowDetailCaptionPlain : WindowDetailCaption
    {
        ...
        static WindowDetailCaptionPlain()
        {
            ...
            _images = ResourceHelper.LoadBitmapStrip(Type.GetType("River.Orqa.Controls.Docking.WindowDetailCaptionPlain"),
                                                     "River.Orqa.Controls.Resources.ImagesCaptionPlain.bmp",
        ...
        protected override void UpdateMaximizeImage()
        {
            ...
            if (_maxButton != null)
            {
				...
				if (_maxInterface.Direction == Common.Direction.Vertical)
                {
                    if (maximized)
    ...
    public class WindowDetailCaptionIDE : WindowDetailCaption
    {
        ...
        {
            // Create a strip of images by loading an embedded bitmap resource
            _images = ResourceHelper.LoadBitmapStrip(Type.GetType("River.Orqa.Controls.Docking.WindowDetailCaptionIDE"),
                                                     "River.Orqa.Controls.Resources.ImagesCaptionIDE.bmp",
                                                     new Size(_imageWidth, _imageHeight),
                                                     new Point(0,0));
        }
