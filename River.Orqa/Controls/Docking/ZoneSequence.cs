...
using River.Orqa.Controls.Docking;
...
namespace River.Orqa.Controls.Docking
{
    ...
    public class ZoneSequence : Zone, IHotZoneSource, IZoneMaximizeWindow, IResizeSource
    {
        ...
        public ZoneSequence(DockingManager manager)
            : base(manager)
        {
            InternalConstruct(VisualStyle.IDE, Common.Direction.Vertical, true);
        }

		public ZoneSequence (DockingManager manager, State state, VisualStyle style, River.Orqa.Controls.Common.Direction direction, bool zoneMinMax)
            : base(manager, state)
        {
            InternalConstruct(style, direction, zoneMinMax);
        }

		protected void InternalConstruct (VisualStyle style, River.Orqa.Controls.Common.Direction direction, bool zoneMinMax)
        {
        ...
        protected void RepositionZoneBar(ref Rectangle clientRect)
        {
            ...
            {
                case State.DockLeft:
                    _resizeBar.Direction = Common.Direction.Horizontal;
                    ...
                    break;
                case State.DockTop:
					_resizeBar.Direction = Common.Direction.Vertical;
