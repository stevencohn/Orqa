...
namespace River.Orqa.Controls.Docking
{
    ...
    public class TabStub : UserControl
    {
		private class DrawTab
		{
            ...
            protected River.Orqa.Controls.Controls.TabPage _tabPage;
			...
			public River.Orqa.Controls.Controls.TabPage TabPage  { get { return _tabPage; } }
		...
		protected void ResizeControl()
		{
			...
			{
				foreach(River.Orqa.Controls.Controls.TabPage page in _tabPages)
				{
