...
namespace River.Orqa.Controls.Controls
{
    ...
    [Designer(typeof(River.Orqa.Controls.Controls.TabControlDesigner))]
    public class TabControl : UserControl
    {
        ...
        static TabControl()
        {
            ...
            _internalImages = ResourceHelper.LoadBitmapStrip(Type.GetType("River.Orqa.Controls.Controls.TabControl"),
                                                             "River.Orqa.Controls.Resources.ImagesTabControl.bmp",
