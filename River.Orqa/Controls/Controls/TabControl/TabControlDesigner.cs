...
namespace River.Orqa.Controls.Controls
{
    public class TabControlDesigner :  System.Windows.Forms.Design.ParentControlDesigner
    {
        ...
        public override ICollection AssociatedComponents
        {
            get 
            {
                if (base.Control is River.Orqa.Controls.Controls.TabControl)
                    return ((River.Orqa.Controls.Controls.TabControl)base.Control).TabPages;
                else
        ...
        protected override void WndProc(ref Message msg)
        {
            ...
            if (msg.Msg == (int)Win32.Msgs.WM_LBUTTONDOWN)
            {
                ...
                River.Orqa.Controls.Controls.TabControl tabControl = this.SelectionService.PrimarySelection as River.Orqa.Controls.Controls.TabControl;
