...
namespace River.Orqa.Controls.Controls
{
    ...
    public class WizardControl : UserControl
	{
        ...
        protected River.Orqa.Controls.Controls.TabControl _tabControl;
        ...
        static WizardControl()
        {
            ...
            _standardPicture = ResourceHelper.LoadBitmap(Type.GetType("River.Orqa.Controls.Controls.WizardControl"),
                                                         "River.Orqa.Controls.Resources.WizardPicture.bmp");
        }
		...
		{
            this._tabControl = new River.Orqa.Controls.Controls.TabControl();
            ...
            this._tabControl.Appearance = River.Orqa.Controls.Controls.TabControl.VisualAppearance.MultiDocument;
                ...
                if (_profile != value)
                {
                    ...
                    switch(_profile)
                    {
                        ...
                        case Profiles.Configure:
							...
							_tabControl.HideTabsMode = River.Orqa.Controls.Controls.TabControl.HideTabsModes.HideAlways; 
                            break;
                        case Profiles.Controller:
                            // Controller is always full page
                            EnterFullPage();

							_tabControl.HideTabsMode = River.Orqa.Controls.Controls.TabControl.HideTabsModes.ShowAlways;
                            break;
                    }
