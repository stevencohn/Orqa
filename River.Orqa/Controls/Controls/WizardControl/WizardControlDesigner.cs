...
namespace River.Orqa.Controls.Controls
{
    public class WizardControlDesigner :  System.Windows.Forms.Design.ParentControlDesigner
    {
        ...
        public override ICollection AssociatedComponents
        {
            get 
            {
                if (base.Control is River.Orqa.Controls.Controls.WizardControl)
                    return ((River.Orqa.Controls.Controls.WizardControl)base.Control).WizardPages;
                else
        ...
        protected override void WndProc(ref Message msg)
        {
            ...
            {
                River.Orqa.Controls.Controls.WizardControl wizardControl = this.SelectionService.PrimarySelection as River.Orqa.Controls.Controls.WizardControl;

                // Check we have a valid object reference
                if (wizardControl != null)
                {
                    River.Orqa.Controls.Controls.TabControl tabControl = wizardControl.TabControl;
