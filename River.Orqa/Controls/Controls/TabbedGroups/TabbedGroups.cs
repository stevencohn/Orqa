...
namespace River.Orqa.Controls
{
    ...
    public class TabbedGroups : UserControl, ISupportInitialize, IMessageFilter
	{
            ...
            set
            {
                if (_activeLeaf != value)
                {
                    ...
                    if (_activeLeaf != null)
                    {
						...
						River.Orqa.Controls.Controls.TabControl tc = _activeLeaf.GroupControl as Controls.TabControl;
                    ...
                    {
                        // Get access to the contained tab control
						River.Orqa.Controls.Controls.TabControl tc = value.GroupControl as Controls.TabControl;
        ...
        public virtual void OnTabControlCreated(Controls.TabControl tc)
        {
			...
			tc.Appearance = River.Orqa.Controls.Controls.TabControl.VisualAppearance.MultiDocument;
            tc.BoldSelectedPage = false;
            ...
            switch(_displayTabMode)
            {
                case TabbedGroups.DisplayTabModes.ShowAll:
                    tc.HideTabsMode = River.Orqa.Controls.Controls.TabControl.HideTabsModes.ShowAlways;
                    break;
                case TabbedGroups.DisplayTabModes.HideAll:
					tc.HideTabsMode = River.Orqa.Controls.Controls.TabControl.HideTabsModes.HideAlways;
                    break;
            }
            ...
            if (_activeLeaf != null)
            {
                ...
                if (tc.SelectedTab != null)
                {
                    ...
                    if (tc.TabPages.Count > 1)
                    {
                        ...
                        {
							if (_root.Direction == Common.Direction.Vertical)
                                allowVert = true;
                            else
                                allowHorz = true;
                        }
