...
namespace River.Orqa.Controls
{
	public class TabGroupLeaf : TabGroupBase
	{
        ...
        static TabGroupLeaf()
        {
            ...
            _internalImages = ResourceHelper.LoadBitmapStrip(Type.GetType("River.Orqa.Controls.Controls.TabbedGroups"),
                                                             "River.Orqa.Controls.Resources.ImagesTabbedGroups.bmp",
                ...
                case NotifyCode.DisplayTabMode:
                    ...
                    switch(_tabbedGroups.DisplayTabMode)
                    {
                        case TabbedGroups.DisplayTabModes.ShowAll:
                            _tabControl.HideTabsMode = Controls.TabControl.HideTabsModes.ShowAlways;
                            break;
                        case TabbedGroups.DisplayTabModes.HideAll:
                            _tabControl.HideTabsMode = Controls.TabControl.HideTabsModes.HideAlways;
                            break;
                        case TabbedGroups.DisplayTabModes.ShowActiveLeaf:
                            _tabControl.HideTabsMode = (_tabbedGroups.ActiveLeaf == this ? Controls.TabControl.HideTabsModes.ShowAlways :
                                                                                           Controls.TabControl.HideTabsModes.HideAlways);
                            break;
                        case TabbedGroups.DisplayTabModes.ShowMouseOver:
                            _tabControl.HideTabsMode = Controls.TabControl.HideTabsModes.HideWithoutMouse;
                            break;
        ...
        internal void NewVerticalGroup(TabGroupLeaf sourceLeaf, bool before)
        {
            ...
            if (tgs != null)
            {
				tgs.Direction = Common.Direction.Vertical;
