...
namespace River.Orqa.Controls
{
	...
	public class TargetManager
	{
	    ...
	    {
            _validCursor = ResourceHelper.LoadCursor(Type.GetType("River.Orqa.Controls.Controls.TabbedGroups"),
                                                                  "River.Orqa.Controls.Resources.TabbedValid.cur");

            _invalidCursor = ResourceHelper.LoadCursor(Type.GetType("River.Orqa.Controls.Controls.TabbedGroups"),
                                                                    "River.Orqa.Controls.Resources.TabbedInvalid.cur");
        }
