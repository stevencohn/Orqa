...
using River.Orqa.Controls.Win32;
using River.Orqa.Controls.Menus;
using River.Orqa.Controls.Common;
using River.Orqa.Controls.Controls;
using River.Orqa.Controls.Collections;

namespace River.Orqa.Controls.Menus
{
    [ToolboxBitmap(typeof(MenuControl))]
    [DefaultProperty("MenuCommands")]
    [DefaultEvent("PopupSelected")]
    [Designer(typeof(River.Orqa.Controls.Menus.MenuControlDesigner))]
    public class MenuControl : ContainerControl, IMessageFilter
    {
		...
		protected River.Orqa.Controls.Common.Direction _direction;
        ...
        static MenuControl()
        {
            ...
            _menuImages = ResourceHelper.LoadBitmapStrip(Type.GetType("River.Orqa.Controls.Menus.MenuControl"),
                                                         "River.Orqa.Controls.Resources.ImagesMenuControl.bmp",
        ...
        public MenuControl()
        {
			...
			_direction = Common.Direction.Horizontal;
        ...
        [Category("Appearance")]
		public River.Orqa.Controls.Common.Direction Direction
        {
            ...
            set
            {
                ...
                switch(value)
                {
                    ...
                    case DockStyle.Right:
                        this.Width = 0;
						_direction = Common.Direction.Vertical;
                        break;
                }
        ...
        protected void Recalculate()
        {
			...
			if (_direction == Common.Direction.Horizontal)
                length = this.Width;
            else 
                length = this.Height;
                        ...
                        switch(_style)
                        {
                            case VisualStyle.IDE:
                                if (_selected)
                                {
									...
									if (_drawUpwards && (_direction == Common.Direction.Horizontal))                                    
									{
