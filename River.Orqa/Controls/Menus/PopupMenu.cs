...
namespace River.Orqa.Controls.Menus
{
    ...
    public class PopupMenu : NativeWindow
    {
        ...
        static PopupMenu()
        {
            ...
            _menuImages = ResourceHelper.LoadBitmapStrip(Type.GetType("River.Orqa.Controls.Menus.PopupMenu"),
                                                         "River.Orqa.Controls.Resources.ImagesPopupMenu.bmp",
                                                         new Size(16,16),
                                                         new Point(0,0));
        ...
        internal MenuCommand TrackPopup(Point screenPos, 
										...
										River.Orqa.Controls.Common.Direction direction,
...
//						Console.WriteLine("Track {0} {1}", this.Handle, ((Win32.Msgs)msg.message).ToString());
        ...
        protected void SetWindowRegion(Size winSize)
        {
            ...
            if (_style == VisualStyle.IDE)
            {
				...
				if (!((_direction == Common.Direction.Vertical) && !_excludeTop))
                {
        ...
        { 
            ...
            switch(_style)
            {
                case VisualStyle.IDE:
                    ...
                    if ((_borderGap > 0) && (!_excludeTop) && (_direction == Common.Direction.Horizontal))
                    {
